...
RES_all_sp_aphid_count<-mclapply(X=c(1:20),FUN=RES_single_sp,d_allsp=data_aphid_count,
                                 families=c(1,3:10,13,14,16:20),level=0.05,data_pt_thrs=35,
...
for(sp in c(1:20)){
  ...
  LTmUT<-(RES_all_sp_aphid_count[[sp]]$LTdep_AICw - RES_all_sp_aphid_count[[sp]]$UTdep_AICw) # total loc pair 182
