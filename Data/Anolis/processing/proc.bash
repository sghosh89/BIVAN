...
python csv_to_nexus.py GA_Anolis_traits.csv > GA_Anolis_traits.nex 2>constrasts.csv || exit
python pic1.py GA_Anolis_traits.nex GA_Anolis_MCC.nex >> constrasts.csv || exit
