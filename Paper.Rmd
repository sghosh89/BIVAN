---
title: "The importance of a complete description of dependence between variables for ecology and related fields"
...
Complex, informative, and previously ignored dependencies propogate throughout ecology and can be revealed with copulas
...
\noindent 7 figures, 3 tables, 0 text boxes
...
Well-developed approaches exist, and are 
...
broader application of the concepts behind these approaches 
in ecology. The approaches are based on 
...
and Y is on the vertical, then Fig. \ref{fig_cop_pedag1}I 
...
information can help support or refute alternative causal hypotheses.
...
We will explore how details, captured by copulas, of the 
dependence between local quantities can influence the spatial 
mean or sum, and how this may influence higher organizational levels in 
ecology and human concerns. Illustrating the idea here, prior work demonstrated that the overall 
...
correlation were unchanged, would have much more benign effects.

We approached our overall goal of exploring the potential of 
copula approaches for ecology by addressing the 
following specific questions. (Q1) Do datasets in ecology 
...
copula structure and tail dependence for our understanding of ecology and for 
...
data and models to explore a variety of consequences. The ninth section is the Discussion. 
Copula approaches have been used to great consequence in neuroscience [@onken2009], 
bioinformatics 
...
description of dependence will be substantial.
...
We addressed Q1 principally via a model selection procedure in which the 
...
values to the lower- and upper-tail dependence values of an N copula (i.e., 0). The third part of Q1
...
provide greater 
confidence in our answer to Q1. We used three 
...
of Q1. The values also differed substantially 
...
<!--bivariate summary-->
Table \ref{tab_bivar_summary} summarizes Q1 results for the bivariate datasets. The two 
...
answering the second and third parts of Q1. The first three datasets had stronger upper- 
...
the first part of Q1. Goodness of fit tests 
...
Q1. These data have greater tail dependence 
...
than the spatial synchrony of outbreaks. This also answers the third part of Q1.
...
Table \ref{tab_multivar_summary} summarizes Q1 results from
...
knitr::kable(tab_bivar_summary[1:9,], 
             format="latex",
             caption = "Summary of Q1 results for bivariate datasets. The $p$-values in rows 5-6 are for the minimum-AIC copula. Model averaging used for rows 7-9 was based on AIC weights. Cedar Creek results are for the year 2000.\\label{tab_bivar_summary}",
             booktabs=T, linesep = "\\addlinespace",
...
common, we addressed Q2 by exploring, using 
...
non-parametric statistics (methods for Q1) to these 
...
the nonlinear models described in the methods for Q2.\label{fig_Cause4copula_scatter_C_kend_ar1}}
\end{center}
\end{figure}
