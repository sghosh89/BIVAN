...
Plotter_Cause4copula_stat(N=5000,numsim=50,fcode=fcode,method="spearman",lb=0,ub=0.1,num_keep_last=500,resloc=resloc,
                          params=params,p0=c(0,0),model=model)

Plotter_Cause4copula_stat(N=5000,numsim=50,fcode=fcode,method="kendall",lb=0,ub=0.1,num_keep_last=500,resloc=resloc,
                          params=params,p0=c(0,0),model=model)
...
for(i in rlist){
  params<-c(i,100) # this parameter is a vector with r and K
  p0<-c(params[2],params[2])

  resloc<-"./Results/Cause4copula_results/"

  tempo<-paste(resloc,"Cause4copula_stat_results_",model,"_r_",params[1],"_K_",params[2],"_",BiCopName(fcode,short=F),sep="")
