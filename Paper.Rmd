...
\noindent \emph{Type of Submission:} Article
...
The first mechanism, summarized conceptually in the Introduction, relates to 
...
mechanism analyzed below (Fig. \ref{MasterFigure}, B) 
...
causal hypothesis, Fig. \ref{MasterFigure}, D, 
...
interacted strongly with model nonlinearities when the model was in its overcompensatory 
regime.  

For our model, hypothesis D (Fig. \ref{MasterFigure}) was 
...
We also examined hypothesis Y (Fig. \ref{MasterFigure}), i.e., that spatial 
...
hypothesis X. For datasets that
...
lower skew than they would otherwise, because negative impacts of cold winters
