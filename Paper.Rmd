...
colnames(tab_copula_info)<-c("Copula family","No. of parameters","Stronger dependent tail", "Reference")
...
tab_copula_info$`Stronger dependent tail`<-c("None",
                                             "Lower","Upper",
                                             "Upper","Lower",
                                             "Upper","Lower",
                                             "None",
                                             "Any (depending on the parameters)","Any (depending on the parameters)",
                                             "Upper","Lower",
                                             "Any (depending on the parameters)","Any (depending on the parameters)",
                                             "Either upper or none (depending on the parameters)","Either lower or none (depending on the parameters)")
...
knitr::kable(tab_copula_info, 
             format="latex", align="l",escape=F,
             caption = "Summary table for the sixteen copula families we used (see section \\ref{Background}). \\label{tab_copula_info}", 
             booktabs = T,linesep = "\\addlinespace") %>%
