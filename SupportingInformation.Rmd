...
```{r tab_summary_notation, echo=F, results='asis',message=F}
library(tinytex)
library(tibble)
library(kableExtra)
library(dplyr)

tab_summary_notation<- tibble(Notation=c("xi,yi", "$ui,vi$",
                                 "(X,Y)", "F",
                                 "FX, FY","C",
                                 "D", "GA,GB",
                                 "$\\lambda_{L}$, $\\lambda_{U}$",
...
# Methods for the hypothetical evolutionary mechanism for tail dependence between traits \label{evol_mech}
...
matrix were constructed similarly, but using a survival Clayton copula and a normal copula,
respectively. 
...
section \\ref{Causes} of the main text (i.e., Figs \\ref{MT-fig_ms_asym_b_0.1} and 
\\ref{fig_ms_asym_b_-0.1_0.5_-0.5}) were subjected to the model 
selection procedures detailed in section \\ref{Methods} of the main text. 
Best-fit copula AICw: the AIC weight of the best-fitting copula family;
...
```{r plot_cause4copula_stat_ricker_C, echo=F, results="hide",cache=T, cache.extra=list(seed,tag_ricker_C,mtime("Plotter_Cause4copula_stat.R"))}
...
```{r plot_cause4copula_stat_ricker_SC, echo=F, results="hide",cache=T, cache.extra=list(seed,tag_ricker_SC,mtime("Plotter_Cause4copula_stat.R"))}
...
```{r plot_cause4copula_stat_ricker_G, echo=F, results="hide",cache=T, cache.extra=list(seed,tag_ricker_G,mtime("Plotter_Cause4copula_stat.R"))}
...
```{r plot_cause4copula_stat_ricker_SG, echo=F, results="hide",cache=T, cache.extra=list(seed,tag_ricker_SG,mtime("Plotter_Cause4copula_stat.R"))}
...
```{r plot_cause4copula_stat_ricker_J, echo=F, results="hide",cache=T, cache.extra=list(seed,tag_ricker_J,mtime("Plotter_Cause4copula_stat.R"))}
...
```{r plot_cause4copula_stat_ricker_SJ, echo=F, results="hide",cache=T, cache.extra=list(seed,tag_ricker_SJ,mtime("Plotter_Cause4copula_stat.R"))}
...
op<-par(mfrow=c(1,4),mar=c(8,8,2,1),mgp=c(4,1,0))
##plot TL for clayton
plot(kend.points.res[[1]][,1,],kend.points.res[[1]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(kend.points.res[[1]][,1,1],kend.points.res[[1]][,2,1],type='p',pch=19,cex=2,col='black')
points(kend.points.res[[1]][,1,2],kend.points.res[[1]][,2,2],type='p',pch=1,cex=2,col='black')
mtext(paste("Clayton"),side = 3, line=-2, adj=0.1, col="black",cex=2)

##plot TL for normal copula
plot(kend.points.res[[2]][,1,],kend.points.res[[2]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(kend.points.res[[2]][,1,1],kend.points.res[[2]][,2,1],type='p',pch=19,cex=2,col='black')
points(kend.points.res[[2]][,1,2],kend.points.res[[2]][,2,2],type='p',pch=1,cex=2,col='black')
mtext(paste("Normal"),side = 3, line=-2, adj=0.1, col="black",cex=2)

#plot TL for frank
plot(kend.points.res[[3]][,1,],kend.points.res[[3]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(kend.points.res[[3]][,1,1],kend.points.res[[3]][,2,1],type='p',pch=19,cex=2,col='black')
points(kend.points.res[[3]][,1,2],kend.points.res[[3]][,2,2],type='p',pch=1,cex=2,col='black')
mtext(paste("Frank"),side = 3, line=-2, adj=0.1, col="black",cex=2)

#plot TL for survival clayton
plot(kend.points.res[[4]][,1,],kend.points.res[[4]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(kend.points.res[[4]][,1,1],kend.points.res[[4]][,2,1],type='p',pch=19,cex=2,col='black')
points(kend.points.res[[4]][,1,2],kend.points.res[[4]][,2,2],type='p',pch=1,cex=2,col='black')
mtext(paste("Survival Clayton"),side=3, line=-2, adj=0.1, col="black",cex=2)
...
pdf("./Results/taylorslaw_results/SpatialTL_7stats_kendall.pdf",height=3,width=22)
op<-par(mfrow=c(1,7),mar=c(8,8,2,1),mgp=c(3,1,0))
...
#}
boxplot(s.lin , col="grey", xlab="Copula family", ylab="p-vals", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Linearity test", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.hom distr for each set of surrogates
boxplot(s.hom , col="grey", xlab="Copula family", ylab="p-vals", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Homoskedasticity test", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)


#plot s.rmse distr for each set of surrogates
boxplot(s.rmse , col="grey" , xlab="Copula family", ylab="rmse", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.int distr for each set of surrogates
boxplot(s.int , col="grey" , xlab="Copula family", ylab="intercept", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.slope distr for each set of surrogates
boxplot(s.slope , col="grey" , xlab="Copula family", ylab="slope", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.quadcoeff distr for each set of surrogates
boxplot(s.quadcoeff , col="grey" , xlab="Copula family", ylab="quadratic \n coefficient", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.mncurv distr for each set of surrogates
boxplot(s.mncurv , col="grey" , xlab="Copula family", ylab="mean \n curvature", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)
...
op<-par(mfrow=c(1,4),mar=c(8,8,2,1),mgp=c(4,1,0))
##plot TL for clayton
plot(spea.points.res[[1]][,1,],spea.points.res[[1]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(spea.points.res[[1]][,1,1],spea.points.res[[1]][,2,1],type='p',pch=19,cex=2,col='black')
points(spea.points.res[[1]][,1,2],spea.points.res[[1]][,2,2],type='p',pch=1,cex=2,col='black')
mtext(paste("Clayton"),side = 3, line=-2.5, adj=0.1, col="black",cex=2)

##plot TL for normal copula
plot(spea.points.res[[2]][,1,],spea.points.res[[2]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(spea.points.res[[2]][,1,1],spea.points.res[[2]][,2,1],type='p',pch=19,cex=2,col='black')
points(spea.points.res[[2]][,1,2],spea.points.res[[2]][,2,2],type='p',pch=1,cex=2,col='black')
mtext(paste("Normal"),side = 3, line=-2.5, adj=0.1, col="black",cex=2)

#plot TL for frank
plot(spea.points.res[[3]][,1,],spea.points.res[[3]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(spea.points.res[[3]][,1,1],spea.points.res[[3]][,2,1],type='p',pch=19,cex=2,col='black')
points(spea.points.res[[3]][,1,2],spea.points.res[[3]][,2,2],type='p',pch=1,cex=2,col='black')
mtext(paste("Frank"),side = 3, line=-2, adj=0.1, col="black",cex=2)

#plot TL for survival clayton
plot(spea.points.res[[4]][,1,],spea.points.res[[4]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(spea.points.res[[4]][,1,1],spea.points.res[[4]][,2,1],type='p',pch=19,cex=2,col='black')
points(spea.points.res[[4]][,1,2],spea.points.res[[4]][,2,2],type='p',pch=1,cex=2,col='black')
mtext(paste("Survival Clayton"),side=3, line=-2.5, adj=0.1, col="black",cex=2)
...
pdf("./Results/taylorslaw_results/SpatialTL_7stats_spearman.pdf",height=3,width=24)
op<-par(mfrow=c(1,7),mar=c(8,9,4,1),mgp=c(4,1,0))
x2<-c("C", "N", "F", "SC")
...
$a_i(t)$, $t=1,\ldots,T$ by the $k^{\text{th}}$ smallest (non-`NA`) 
...
is the Kendall tau-b coefficient in the event of ties, an index which 
...
As described in the main text, we examined using simulations 
whether copula structure influences spatial Taylor's law; details are provided here. 
First, an $n \times n$ covariance matrix $\Sigma$ was created
...
The cdf of the standard normal distribution was applied to these numbers, followed by the 
...
was normal for this array. The array contains $1000$ population matrices.
...
in the `copula` package in R. Because the Clayton copula is a one-parameter family, this 
...
sampling location and simulation. So population marginal distributions for each location
...
if $m^{(\text{N},k)}_{t,j}$ is our normal-copula population array (the three dimensions 
of the array are indexed, respectively, by $t$, $j$ and $k$), and $m^{(\text{C},k)}_{t,j}$ is our 
Clayton-copula population array, then,
for any given $j$ and $k$, the sets $\{m^{(\text{N},k)}_{t,j}: t=1,\ldots,N\}$ and 
$\{m^{(\text{C},k)}_{t,j}: t=1,\ldots,N\}$ are exactly the same (when considered 
as unordered sets); 
and for any given $j_1$, $j_2$ and $k$ with $j_1 \neq j_2$, the Spearman correlations $\cor_t(m^{(\text{C},k)}_{t,j_1},m^{(\text{C},k)}_{t,j_2})$
and $\cor_t(m^{(\text{N},k)}_{t,j_1},m^{(\text{N},k)}_{t,j_2})$ are the same, to within 
...
draws from $C$.
- For each $k$ and $i$, replace the $k^{\text{th}}$-smallest element of the time series $a_i(t)$, 
$t=1,\ldots,T$ by the $k^{\text{th}}$ smallest element of $x_i(t)$, $t=1,\ldots,T$. Call the 
result $y_i(t)$. This is the surrogate dataset.

<!--Moved this stuff to main text for AER
...
get_ms_aphid_temp<-function(sp,d_copsp){
  ...
  for(loc in 1:lengoodloc){
    ...
    colnames(m)<-c("p.Indep","minAIC.bestfit.cop",
                   "Bestfit.cop.AIC", "Normal.cop.AIC",
                   "p.CvM","p.KS",
                   "LT.model.avg","UT.model.avg","(LT-UT).model.avg",
    ...
    if(ms_res$IndepTestRes<0.05){
      ...
      m$Bestfit.cop.AIC<-round(min(ms_res$InfCritRes$AIC),3)
      m$Normal.cop.AIC<-round(ms_res$InfCritRes$AIC[1],3)
