...
is correlated across locatons ($\epsilon$) and by a local factor ($\delta$). 
...
surrogates (see section on methods for Q1) to these 
...
<!--***DAN: stopped here in Q2 methods in order to go on to the correspondng
section of Q2 results-->
...
strongly reflected the visually apparent asymmetry (Tables \ref{tab_stat_npa_asym}). 
...
present so far in this section are theoretical.
...
<!--***DAN: got to here so far in editing the result for Q2-->
