...
N-copula null hypothesis. Red dots are empirical 
skewnesses; see text 
...
\end{center}
\end{figure}
<!--***DAN: Shya, please replace the x axis label by "Skewness" and the y-axis label
by "Frequency" in the above plot-->
...
had cuvatures less than at least $95\%$ of surrogate datasets ($p=X$, $Y$, $Z$ for 
the $A$, $B$ and $C$ species, respectively). 
...
by the fact that only $39$ of $10000$ surrogates had curvature less than that
