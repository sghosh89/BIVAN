...
@Popovic2018 used copulas to illuminate causal relationships
between species. 
...
bootstrapping procedure of @Wang2000 and @Genest2006,
...
described in detail elsewhere [@Joe1997; @Brechmann2013]. So 
...
180 degrees. 
See @Joe1997 and @Brechmann2013 for details on all families. We used the implementations
of provided in the `VineCopula` package for the R programming
...
is correlated across locations ($\epsilon$) and by a local factor ($\delta$). 
The function $g$ describes how $\epsilon_i(t)$ influences
