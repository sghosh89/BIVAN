...
Version 4.3 of the DendroPy library [@SukumaranH2010] was used to calculate 
...
plotter_asym_sens_beta_varn<-function(N,rho,alpha,beta,numkeep_last,ploton){

  pop<-Simulator_asym_sens(N=N,rho=rho,alpha=alpha,beta=beta,p0=c(0,0),decrease=F,numkeep_last=numkeep_last)
  pop_d<-Simulator_asym_sens(N=N,rho=rho,alpha=alpha,beta=beta,p0=c(0,0),decrease=T,numkeep_last=numkeep_last)
  
  neg_beta<- -beta
  pop_neg_beta<-Simulator_asym_sens(N=N,rho=rho,alpha=alpha,beta=neg_beta,p0=c(0,0),decrease=F,numkeep_last=numkeep_last)
  pop_d_neg_beta<-Simulator_asym_sens(N=N,rho=rho,alpha=alpha,beta=neg_beta,p0=c(0,0),decrease=T,numkeep_last=numkeep_last)
...
ans_beta_0.1<-plotter_asym_sens_beta_varn(N=N,rho=rho,alpha=alpha,beta=0.1,numkeep_last=numkeep_last,ploton=T)
dev.off()

pdf("./Results/asym_sens_results/beta_0.9_asym_sens.pdf")
ans_beta_0.9<-plotter_asym_sens_beta_varn(N=N,rho=rho,alpha=alpha,beta=0.9,numkeep_last=numkeep_last,ploton=T)
dev.off()
