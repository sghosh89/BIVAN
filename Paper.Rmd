...
normal copula had a much higher AIC, $-6333.16$, 
<!--***DAN: Shyamolina, please make this an autolink. Please make 
sure to round to two digits after the decimal, as with the AIC best value
...
DONE Figures S24-27
DONE Tables S7-14, keep Table S15
DONE Tables S16-23, keep S24
DONE S25-32, keep S33
DONE S34-42, keep S42

DONE You will have to go back to the methods and revise those parts
-->
...
for the large majority of location pairs (72 of 90 pairs), 
<!--***DAN: Shyamolina, please make these numbers autolinks-->
and the AIC
of the normal copula minus the minimum AIC, averaged across 
location pairs, was $2.732$.
<!--***DAN: Shyamolina, please make this an autolink, so the value is
automatically filled in even if it changes-->
Whereas $2.732$
<!--***DAN: Shyamolna, again, autolink, please-->
...
the chances of getting 72 or more 
...
(B,A)) is low, $`r 1-pbinom(72/2-1,45,.5)`$. 
<!--***DAN: Shyamolina, please replace the 72 in the above expression
by an autolink, and make this show
3 significant digits, i.e., it should show 3.29e-5, not 3.287332e-05-->
...
$(0.123,0.721)$ and $(0.002,0.41)$, respectively,
<!--***DAN: Shyamolina, autolink pls -->
...
again low, $`r 1-pbinom(86/2-1,45,.5)`$. 
<!--***DAN: Shyamolina, please autolink this, and use 3 sig figs as 
before-->
...
<!--***DAN: got to here. Next step, put in the actual nonparam stats results which are currently in the Appendices-->
