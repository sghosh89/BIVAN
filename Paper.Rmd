...
local noise, independent across time and sampling locations. We used $b=0.1, -0.1, 0.9, -0.9$ and
...
$\cov(\epsilon_1,\epsilon_2)=0.8$. Negative values of $b$ correspond to overcompensating dynamics 
...
in all cases.
<!--***DAN: Dan to rewrite this para after seeing the complete collection of results-->
