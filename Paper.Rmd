...
\noindent Reid: School of Biological & Marine Sciences, University of Plymouth, Drake Circus, Plymouth PL4 8AA, United Kingdom
...
tab_data_info$Data<-c("Soil C and N","Bird body masses and BMR", "Mammal body masses and BMR", 
                      "Green spruce and other aphid species abundances", "Leaf-curling plum and other aphid first flight dates","Ceratium furca and other plankton taxa abundances", "Plant diversity and aboveground biomass","Methane flux")
...
present results in for an example bivariate dataset; then we summarize results
...
structure on Taylor's law, which is has been applied in many fields.
...
which community properties show "spikiness".
Future work on copula structure of interspecific relationships in communities and its
implications for community stability seems likely to be an exciting avenue of research.
