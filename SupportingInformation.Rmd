...
$\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and  $\Dsq_l$ against distance between pairs of  
locations shows these quantities also decline with distance (Figure \ref{fig_aphid_count} C-H).
<!--DAN add reference and revisit the text here once Shya add these panels-->
...
<!--Shya, can you please add panels for corl, coru, Pl, Pu, D2l, D2u vs. distance, following the Spearman and Kendall
panels? I think it will be the first time anyone has shown these, so we should show the decline with distance
holds for these as well. That means you'll have 6 new panels, for a total of 11 panels. So it'll be a big figure, 
possibly taking up a whole page, or most of one. Similar changes, please,
to the analogous figs for the aphid ff and ceratium furca data.-->
\begin{figure}[!h]
\begin{center}
\textbf{\;\;\;\;\;\;\;\ (A) \;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\ (B)} \\
...
Plotting Spearman or Kendall correlations between first flight time series for pairs of locations as a function of great circle distance between the locations (Figure \ref{fig_aphid_ff} A, B) showed the typical (though slight, in this case) decline of correlation with increasing distance. Plotting $\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$, and $\Dsq_l$ against distances between pairs of locations shows these quantities also decline with distance (Figure \ref{fig_aphid_ff} C-H).
<!--DAN: make sure this is true when you see the plots again-->
...
<!--Shya, pls add 6 new panels as described in my comment near the analogous figure for aphid count-->
\begin{figure}[!h]
\begin{center}
\textbf{\;\;\;\;\;\;\;\ (A) \;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\ (B)} \\
...
<!--DAN: effectively stopped here 2018 04 01 10pm-->
