...
knitr::kable(aphid_info, "latex", booktabs = T, linesep = "",
      caption = "Species names of 20 aphids commonly found across UK \\label{tab_aphid_info}",
...
knitr::kable(plankton_info, "latex", booktabs = T, linesep = "",
      caption = "Species names of 22 planktons found across UK seas\\label{tab_plankton_info}",
      col.names = c("Plankton sp. name"))
```
...
<!--***DAN: This is a dumping group at the moment, but needs to be organized into a section that gives all the necessary details about the data-->
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=8 cm,height=8 cm]{./Results/SoilCNmapUSA.pdf} 
\caption{Locations of central pedons with soil organic carbon and total soil nitrogen (Mg C or N per hectare of soil surface) from 5907 sampling sites across the coterminous United States. \label{fig_SoilCNmapUSA}}
\end{center}
\end{figure}
...
# Transformations used in Fig. \ref{MT-fig_cop_pedag1}
...
\caption{Log-transformed pdfs (A-E) and samples (F-J) from example N copulas. 
S is Spearman correlation; p is the value of the parameter for the N family (it is a 
one-parameter family); and LT and UT are the measures of lower- and upper-tail dependence, 
respectively.\label{figped_N}}
\end{center}
\end{figure}
...
\caption{Log-transformed pdfs (A-E) and samples (F-J) from example C copulas. S is Spearman correlation; p is the value of the parameter for the C family (it is a 
one-parameter family); and LT and UT are the measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs (A-E) and samples (F-J) from example SC 
...
\caption{Log-transformed pdfs (A-E) and samples (F-J) from example G copulas. S is 
...
\caption{Log-transformed pdfs (A-E) and samples (F-J) from example SG 
...
\caption{Log-transformed pdfs (A-E) and samples (F-J) from example J copulas. K is Kendall correlation; p is the value of the parameter for the J family (it is a 
one-parameter family); and LT and UT are the measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs (A-E) and samples (F-J) from example SJ 
...
\caption{Log-transformed pdfs (A-E) and samples (F-J) from example F copulas. S is Kendall correlation; p is the value of the parameter for the F family (it is a 
one-parameter family); and LT and UT are the measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs for example BB1 copulas. K is Kendall correlation; p1 and p2
...
\caption{Log-transformed pdfs for example SBB1 copulas. K is Kendall correlation; p1 ad p2 
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are our measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs for example BB6 copulas. K is Kendall correlation; p1 and p2
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are our measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs for example SBB6 copulas. K is Kendall correlation; p1 ad p2 
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are our measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs for example BB7 copulas. K is Kendall correlation; p1 and p2
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are our measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs for example SBB7 copulas. K is Kendall correlation; p1 ad p2 
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are our measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs for example BB8 copulas. K is Kendall correlation; p1 and p2
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are our measures of lower- and upper-tail dependence, 
...
\caption{Log-transformed pdfs for example SBB8 copulas. K is Kendall correlation; p1 ad p2 
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are our measures of lower- and upper-tail dependence, 
...
\caption{Schematic diagram supporting definitions of nonparametric tail dependence statistics. The red and blue lines are, respectively, $u+v=2l_b$ and $u+v=2u_b$.\label{fig_stat_image}}
\end{center}
\end{figure}
