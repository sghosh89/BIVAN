...
Across datasets, copula structures were often non-normal and 
...
Our model selection procedures do not reveal whether the tail dependence values are 
*significantly* different from $0$ and from each other; @burnham2003_modelselection do
not recommend attempts to make statements about statistical significance of 
information-criterion-based, model selection results. 
...
approach, results detailed below, provides informaton about significance of tail
associations and asymmetries of tail associations.

<!--***DAN: Stopped here. Now do the nonpram results.-->

However, nonparametric statistics verified
