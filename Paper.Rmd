...
<!--***DAN: Shyamolina, can you please move what is currently Table S10 (Summary results
for winter temp and green spruce aphid abundance) to here? Please also replace the two
columns that show AICw values by the corresponding AIC values, consistent with the switches
elsewhere in the paper of AICw for AIC.-->
