...
pdf of a normal copula (methods for the observational hypothesis) with 
parameter chosen to
...
Our results provide support for the idea that environmental, ecological and evolutionary processes 
...
correspond to potential causes of non-normal (NN) copula structure that
were examined (in the fifth and sixth sections of the text). Lower boxes 
correspond to potential consequences we examined of NN copula structure for
...
higher organizational levels in eoclogy and human concerns.
...
the marginals of normal distribution. Such 
...
applications? To address Q1 (second through fourth sections of the paper), 
...
The fifth and sixth sections of the paper 
address Q2 using simple models. The seventh and eigths sections address
Q3 using both data and models. The ninth section is the Discussion.
...
To our knowledge, non-normal copulas have never been used in ecology. 
...
dependence: the observational hypothesis (Fig. \ref{MasterFigure}) was supported. To make results easier to absorb, we first 
