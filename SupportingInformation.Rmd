...
```{r fig_risk_K50, echo=F, fig.cap="Plot Extinction risk vs. d(degree of dispersal) for r=1, K=50, numlocs=10, numsteps=25, numsims=1000.\\label{fig_risk_K50}", fig.height=4, fig.width=8}
varying_d(numsims=1000,numsteps =25,numlocs=10,r=1,K=50)
```

```{r fig_risk_K100, echo=F, fig.cap="Plot Extinction risk vs. d(degree of dispersal) for r=1, K=100, numlocs=10, numsteps=25, numsims=1000.\\label{fig_risk_K100}", fig.height=4, fig.width=8}
varying_d(numsims=1000,numsteps =25,numlocs=10,r=1,K=100)
```

```{r fig_risk_K200, echo=F, fig.cap="Plot Extinction risk vs. d(degree of dispersal) for r=1, K=200, numlocs=10, numsteps=25, numsims=1000.\\label{fig_risk_K200}", fig.height=4, fig.width=8}
varying_d(numsims=1000,numsteps =25,numlocs=10,r=1,K=200)
```

```{r fig_risk_numlocs5, echo=F, fig.cap="Plot Extinction risk vs. d(degree of dispersal) for r=1, K=100, numlocs=5, numsteps=25, numsims=1000.\\label{fig_risk_numlocs5}", fig.height=4, fig.width=8}
varying_d(numsims=1000,numsteps =25,numlocs=5,r=1,K=100)
```

```{r fig_risk_numlocs15, echo=F, fig.cap="Plot Extinction risk vs. d(degree of dispersal) for r=1, K=100, numlocs=15, numsteps=25, numsims=1000.\\label{fig_risk_numlocs15}", fig.height=4, fig.width=8}
varying_d(numsims=1000,numsteps =25,numlocs=10,r=1,K=100)
```

```{r fig_risk_numlocs25, echo=F, fig.cap="Plot Extinction risk vs. d(degree of dispersal) for r=1, K=100, numlocs=25, numsteps=25, numsims=1000.\\label{fig_risk_numlocs25}", fig.height=4, fig.width=8}
varying_d(numsims=1000,numsteps =25,numlocs=15,r=1,K=100)
```

  * With increasing $K$, extinction risk decreases [for a fixed $d$ , $r$ and $numlocs$] but this effect is more prominent in
case of left tail-dep data. [see Figure \ref{fig_risk_K50} - Figure \ref{fig_risk_K200}]

  * With increasing $numlocs$, extinction risk decreases [for a fixed $d$ , $r$ and $K$] but this effect is more prominent in
case of left tail-dep data. [see Figure \ref{fig_risk_numlocs5} - Figure \ref{fig_risk_numlocs25}]
