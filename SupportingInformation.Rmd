...
#}
boxplot(s.lin , col=rainbow(4), xlab="Copula family", ylab="p-vals", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Linearity test", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.hom distr for each set of surrogates
boxplot(s.hom , col=rainbow(4), xlab="Copula family", ylab="p-vals", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Homoskedasticity test", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)


#plot s.rmse distr for each set of surrogates
boxplot(s.rmse , col=rainbow(4) , xlab="Copula family", ylab="rmse", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.int distr for each set of surrogates
boxplot(s.int , col=rainbow(4) , xlab="Copula family", ylab="intercept", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.slope distr for each set of surrogates
boxplot(s.slope , col=rainbow(4) , xlab="Copula family", ylab="slope", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.quadcoeff distr for each set of surrogates
boxplot(s.quadcoeff , col=rainbow(4) , xlab="Copula family", ylab="quadratic \n coefficient", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)

#plot s.mncurv distr for each set of surrogates
boxplot(s.mncurv , col=rainbow(4) , xlab="Copula family", ylab="mean \n curvature", cex.axis=2,cex.lab=3,xaxt="n")
mtext("Spatial TL", side=3, cex=1.8,line=1.5)
axis(1, at = c(1:4), x2, cex.axis=2)
