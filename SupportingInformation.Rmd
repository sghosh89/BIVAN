...
measures of asymmetry of tail dependence between two characters, across extant species ($\cor_{0,0.2}-\cor_{0.8,1}$ (A, D, G, J, M), 
$\Ps_{0,0.2}-\Ps_{0.8,1}$ (B, E, H, K, N), and $\Dsq_{0.8,1}-\Dsq_{0,0.2}$ (C, F, I, L, O)) were 
computed for each of 100 simulations for each of five types of tail dependence between 
...
Appendix \ref{evol_mech}.\label{fig_cop_evo}}
\end{center}
\end{figure}
