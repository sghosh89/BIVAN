...
phylogeny for $817$ mammal species taken from @GenoudIM2018.
...
correlation $0.875$, so simulations assess the impact of copula structure of character
changes on evolutionary outcomes, controlling for marginals and correlations of character
changes. For each of the five copula structures, mammalian character
evolution was simulated 100 times. For each simulation, symmetry of tail dependence 
of the two characters was assessed across the phylogeny tips.
...
changes in bird and mammal BMR and body size may exhibit right-tail dependence. This is
a hypothesis only, because the tail dependence of Fig. \ref{fig_biv_multi_raw_cop}F,G
...
dependence in characters of extant species. Even if the hypothesized mechanism
...
See Appendix \ref{evol_mech} for additional thoughts on the potential importance of 
copulas for studies of character evolution when phylogeny branch lengths are not available.

<!-- We have only given three mechanisms, but there are likely to be others, and discoverig
additional mechanisms of copula structure is certain worthy of future work. -->
...
they were extremely simple in other respects, as well, not including phenomena such as 
delayed density dependence, dispersal, stage structure in population dynamics, and trophic
interactions.
We hope by enumerating three potential mechanisms we help inspire additional research on the
potentially numerous mechanisms of copula structure that may apply in diverse datasets.
...
extraction; and Joel E. Cohen, David Tilman, Lauren Hallet, Jim Bever, Jonathan Walter, Thomas 
