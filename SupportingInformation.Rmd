...
For all four bivariate datasets the statistic $P_{0,0.1}-P_{0.9,1}$ was computed for real data and 
for 1000 Kendall-preserving surrogate datasets with N copulas, and the rank of the real-data value in 
the distribution of surrogate values was computed. If ranks were $>975$ or $<25$, asymmetry of tail 
dependence was significant compared to a N-copula null hypothesis. Ranks were 1, 1, 1, 998
<!--***DAN: Shya, please make the quantities in the previous line automatic links-->
...
upper- than lower-tail dependence, and the Cedar Creek data showed the reverse, confirming the 
results based on model selection presented in the main text.
...
multivar_tab_summary_fn<-function(r,rs){
  ...
  bcop[bcop==Inf]<-NaN # replacing nonInd pairs with NaN
