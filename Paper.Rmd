...
first part of Q1 for these data: these data have a dependence structure markedly distinct 
from that of a normal copula. Recall that AIC differences of $2$
...
shown in solid and void black dots to help assess to what extent variation on the plots was between 
