...
stronger right- than left tail association (Fig. \ref{SM-figped_C}). The BB1 copula 
...
(@nelsen2006_copula, section 5.4) that $\lambda_L=\lambda_U=0$ for the N copula,
$\lambda_L=2^{-1/p}$ and $\lambda_U=0$ for a C copula with parameter $p>0$,
and $\lambda_L=0$ and $\lambda_U=2^{-1/p}$ for an SC copula with parameter $p>0$.
