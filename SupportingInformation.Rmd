...
A scatterploy very simlar to Fig. \ref{MT-fig_cop_pedag1}C can be obtained from Fig. \ref{MT-fig_cop_pedag1}A via transformation
...
\caption[Example SBB1 copulas]{Log-transformed pdfs for example SBB1 copulas. K is Kendall correlation; $p_1$ and $p_2$ 
...
\caption[Example SBB6 copulas]{Log-transformed pdfs for example SBB6 copulas. K is Kendall correlation; $p_1$ and $p_2$ 
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are the measures of lower- and upper-tail dependence, 
respectively. The parameter ranges for the family are $p_1 \in [1,\infty)$
...
\caption[Example SBB7 copulas]{Log-transformed pdfs for example SBB7 copulas. K is Kendall correlation; $p_1$ and $p_2$ 
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are the measures of lower- and upper-tail dependence, 
respectively. The parameter ranges for the family are $p_1 \in [1,\infty)$
...
\caption[Example SBB8 copulas]{Log-transformed pdfs for example SBB8 copulas. K is Kendall correlation; $p_1$ and $p_2$ 
denote the two parameters of the family (it is a 
two-parameter family); and LT and UT are the measures of lower- and upper-tail dependence, 
respectively. The parameter ranges for the family are $p_1 \in [1,\infty)$
