...
<!--***DAN: text all good up to here, except as marked (the data section)-->
...
\end{center}
\end{figure}
<!--***DAN: Shya, can you please adjust this figure and the analogous 3 other figures for the other three bivariate datasets as follows: replace the y-axis label "Partial correlation" with "cor", for consistency with the other y-axis labels.
***Shya: Done.-->
...
knitr::kable(round(RES_aphid_count$info_ord_AICw[,,1],3), 
             format='latex',linesep = "",
...
knitr::kable(round(normal_cop_AICw_matrix(r=RES_aphid_count),3),
             format='latex',linesep = "",
...
knitr::kable(round(RES_aphid_count$gfc_p_CvM,3),
             format='latex',linesep = "",
...
knitr::kable(round(RES_aphid_count$gfc_p_KS,3),
             format='latex',linesep = "",
             caption.short="Goodness of fit of best-fitting copulas, green spruce aphid abundance data",
...
knitr::kable(round(RES_aphid_count$LTdep_AICw,3),
             format='latex',linesep = "",
...
knitr::kable(round(RES_aphid_count$UTdep_AICw,3),
             format='latex',linesep = "",
...
knitr::kable(round(RES_aphid_count$LTdep_AICw-RES_aphid_count$UTdep_AICw,3),
             digits = 5,linesep = "",
             format='latex',
...
s<-cbind(sc,s)
colnames(s)<-c("","2.5th quantile", "Mean", "97.5th quantile")
knitr::kable(s,
...
knitr::kable(round(RES_aphid_ff$info_ord_AICw[,,1],3), 
             format='latex',linesep = "",
...
source("normal_cop_AICw.R")
knitr::kable(round(normal_cop_AICw_matrix(r=RES_aphid_ff),3),
             format='latex',linesep = "",
...
knitr::kable(round(RES_aphid_ff$gfc_p_CvM,3),
             format='latex',linesep = "",
...
knitr::kable(round(RES_aphid_ff$gfc_p_KS,3),
             format='latex',linesep = "",
             caption.short="Goodness of fit of best-fitting copulas, leaf-curling plum aphid first flight data",
...
knitr::kable(round(RES_aphid_ff$LTdep_AICw,3),
             format='latex',linesep = "",
...
knitr::kable(round(RES_aphid_ff$UTdep_AICw,3),
             format='latex',linesep = "",
...
knitr::kable(round(RES_aphid_ff$LTdep_AICw-RES_aphid_ff$UTdep_AICw,3),
             digits = 5,
             format='latex',linesep = "",
