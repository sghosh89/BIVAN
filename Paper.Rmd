...
non-N copula structure and tail-dependence in ecology. 
...
Thus tail dependence could have implications for numerous exploited and pest species
for which the spatial average has applied importance.
Extinction risk can be accentuated or reduced by tail dependence
properties of environmental variables. 
In our view, our results make our "overall hypothesis" from the Introduction
reasonable and worthy of broader testing. We illustrated 
how such tests might be carried out by performing them ourselves on 
example datasets and models. Further suggestions for future tests are below.
...
computer implementations exist (the `copula` and 
`VineCopula` packages). Ecologists can start applying these tools
...
that build upon existing methods and may be especially useful for ecology.
