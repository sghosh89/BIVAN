...
<!--***DAN: if you do decide to move the TL stuff to main text, this is where the 
methods go. Other than this, I think I am done revising methods for Q3.-->

<!--***DAN: Just ike in the Causes secton you added a comment saying these models
were for initial exploration only and so we did not explore parameter space
nor look at model variants, likewise we also need some commentary in this section 
indicating that the modelling is simple and not comprehensively explored, because
the purpose is just to get an idea of what kinds of consequences of copula 
structure *may* pertain; further work is needed to understand to what extent these
consequences are realized in real systems.-->

Pursuing ideas that sprang from earlier theoretical work [@Reuman2017], we 
...
So means $m_g$ and variances $v_g$ are computed across space. We consider that 
Taylor's law is validated for a dataset if the 
...
<!--***DAN: the below is on TL and needs to be augmented if we keep TL results-->
