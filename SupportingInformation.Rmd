...
pdf("./Results/skewness_results/skewness_aphid_count/skewness_aphid_count_sp_10.pdf",height=6,width=16)
par(mfrow=c(1,2))
numsurrog<-10000
...
mtext(paste0("(A) p = ",p_left," (for Kendall preserving Normal surrogates)"),side=3,line=0.2,col="navyblue")
...
mtext(paste0("(B) p = ",p_left," (for Spearman preserving Normal surrogates)"),side=3,line=0.2,col="navyblue")
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=16 cm]{./Results/skewness_results/skewness_aphid_count/skewness_aphid_count_sp_10.pdf}
...
pdf("./Results/skewness_results/skewness_aphid_ff/skewness_aphid_ff_sp_11.pdf",height=6,width=16)
par(mfrow=c(1,2))
numsurrog<-10000
...
mtext(paste0("(A) p = ",p_right," (for Kendall preserving Normal surrogates)"),side=3,line=0.2,col="navyblue")
...
mtext(paste0("(B) p = ",p_right," (for Spearman preserving Normal surrogates)"),side=3,line=0.2,col="navyblue")
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=16 cm]{./Results/skewness_results/skewness_aphid_ff/skewness_aphid_ff_sp_11.pdf}
...
pdf("./Results/skewness_results/skewness_plankton_north_sea/skewness_plankton_north_sea_sp_16.pdf",height=6,width=16)
par(mfrow=c(1,2))
numsurrog<-10000
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=16 cm]{./Results/skewness_results/skewness_plankton_north_sea/skewness_plankton_north_sea_sp_16.pdf}
...
pdf("./Results/skewness_results/skewness_methane/skewness_methane.pdf",height=6,width=16)
par(mfrow=c(1,2))
numsurrog<-10000
