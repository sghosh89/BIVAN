...
copula (see section on methods for Q1 in the main text) 
...
# Proofs of statements related to Skalr's theorem in the case of continuous, strictly monotonic margins \label{ContStrictMonoton}
...
$D(G_A(x),G_B(y))$ is guaranteed by Sklar's theorem to be a a distribution function.
We here show that if $G_A$ and $G_B$ and continuous and strictly monotonic, then
...
To see this, note that the distribution function of 
...
$(U,V)$, which proves the statement. In fact, a stronger statement assuming
...
Kendall (or Spearman)
correlation. Thus the comparison addresses the first two parts of Q1
