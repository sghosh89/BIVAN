...
3) What some of the different copula families look like - in particular you will use BB1 in Fig S2 and cite Background, so mention it
...
We introduce some standard copula families, as example illustran
