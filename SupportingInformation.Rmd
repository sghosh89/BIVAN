...
bivar_tab_summary_fn<-function(r,rs){
  ...
  colnames(m)<-c("Indep.p","AIC-best.copula","Highest.AICw",
                 ...
                 "Rank_Pl_surrog","Rank_Pu_surrog","Rank_Pl-Pu_surrog")
  m<-as.data.frame(m)
...
multivar_tab_summary_fn<-function(r,rs){
  ...
  m$`#LT>0`<-sum(r$LTdep_AICw>0,na.rm=T)
  m$`#UT>0`<-sum(r$UTdep_AICw>0,na.rm=T)
