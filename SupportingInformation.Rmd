...
library(captioner)
library(parallel)
busycores<-detectCores()-2 # for parallell computing with mclapply your computer will use all cores except two.
```
...
<!--Following 3 chunks examine the consequence of non-Normal copula atructure on skewness using aphid count, firstflight for 20 sp.
and plankton count data for 22 sp. : these results are currently not showin in either main text or suppmat-->
...
<!--Following 2 chunks examine the consequence of non-Normal copula atructure on Taylors Law 
using real data of aphid count with all 20 sp.-->
