...
will be close to $\tau$ (differences arising only through sampling variation). If the instead of $\theta_\tau$
...
Kendall (or Spearman)
correlation. Significant deviations correspond to deviations from normal copula structure. 
...
s<-stat_aphid_count$numericdf[,2:5]
