...
for(insd in nsdlist){
  ...
  # for clayton with spearman and kendall method
    myres<-Sim_Cause4copula_stat(N=5000,numsim=50,fcode=fcode,nsd=nsd,method="spearman",lb=0,ub=0.1,
                                           num_keep_last=500,resloc=resloc,
                                           params=params,p0=c(0,0),model=model)

    saveRDS(myres,paste(resloc,"ricker_C_spear.RDS",sep=""))

    myres<-Sim_Cause4copula_stat(N=5000,numsim=50,fcode=fcode,nsd=nsd,method="kendall",lb=0,ub=0.1,
                                          num_keep_last=500,resloc=resloc,
                                          params=params,p0=c(0,0),model=model)
...
```{r plot_cause4copula_stat_ricker_C, echo=F, results="hide"}
...
```{r plot_cause4copula_stat_ricker_SC, echo=F, results="hide"}
...
```{r plot_cause4copula_stat_ricker_G, echo=F, results="hide"}
...
```{r plot_cause4copula_stat_ricker_SG, echo=F, results="hide"}
...
```{r plot_cause4copula_stat_ricker_J, echo=F, results="hide"}
...
```{r plot_cause4copula_stat_ricker_SJ, echo=F, results="hide"}
