...
We tested our statistics by testing whether $\cor_l-\cor_u$, $\Ps_l-\Ps_u$, and $\Dsq_u-\Dsq_l$ revealed the asymmetry of tail dependence known to be present in data simulated from various copulas. Fig. \ref{fig_stat_image}(B - D) represent the results for Clayton copulas with $n=35$ data points and $100$ simulations (for details see Appendix \ref{SM-Test_npa_stat}). 
...
Details of how surrogates were prroduced are in XYZ, and code is in ABC.
