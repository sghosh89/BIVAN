...
<!--***DAN: You may also want to have some additional commentary in the Discussion on
how the models and related models can be explored more comprehensively. In fact you may already have some of that, though you may want to beef it up. You may
want to insert a point at the end of the Methids section here again emphasizing
that these are simple models for an initial exploration, and we discuss in the 
Discussion how...-->
...
measures of asymmetry of tail associations ($\cor_{0,0.2}-\cor_{0.8,1}$, A-E; 
...
\end{center}
\end{figure}
<!--***DAN: Shyamolina, can you please make this figure and its caption fit on one page,
somehow?-->
...
the quadratic regression equation itself
...
\begin{figure}[!h]
\textbf{ \hspace{1.4cm} (A) \hspace{2.92 cm} (B) \hspace{2.92 cm} (C) \hspace{2.92 cm} (D)} \\
\vspace{-0.5 cm} 
\begin{center}
\includegraphics[width=16 cm]{./Results/taylorslaw_results/SpatialTL_CNFSC_spearman.png}\\
\end{center}
\textbf{ \hspace{0.6 cm} (E) \hspace{1.4 cm} (F) \hspace{1.4 cm} (G) \hspace{1.4 cm} (H) \hspace{1.4 cm} (I) \hspace{1.4 cm} (J) \hspace{1.4 cm} (K)}\\
\vspace{-0.5 cm}
\begin{center}
...
\end{center}
\end{figure}
<!--***DAN: Shyamolina, the spacing of the panel labels (A, B, C, etc.) is not quite 
matched up with the spacing of the panels themselves, can you fix it please?-->
