...
### nonparametric analysis of tail dependence  \label{Ex_pns_NPA}
                          ----moved to Paper.Rmd----
-->
...
\caption[AR(1) model : comparing correlations and nonparametric statistic between noise-copula (\textbf{Gumbel}) and population copula for different Kendall's correlation]{AR(1) model: similar analysis as depicted in Fig. \ref{fig_Cause4copula_SC_kend_ar1} but for noise generated from upper tail dependent \textbf{Gumbel} copula. \label{fig_Cause4copula_G_kend_ar1}}
\end{center}
\end{figure}
...
\caption[AR(1) model : comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Gumbel}) and population copula for different Kendall's correlation]{AR(1) model: similar analysis as depicted in Fig. \ref{fig_Cause4copula_SC_kend_ar1} but for noise generated from lower tail dependent \textbf{Survival Gumbel} copula. \label{fig_Cause4copula_SG_kend_ar1}}
\end{center}
\end{figure}
...
\caption[AR(1) model : comparing correlations and nonparametric statistic between noise-copula (\textbf{Joe}) and population copula for different Kendall's correlation]{AR(1) model: similar analysis as depicted in Fig. \ref{fig_Cause4copula_SC_kend_ar1} but for noise generated from upper tail dependent \textbf{Joe} copula \label{fig_Cause4copula_J_kend_ar1}}
\end{center}
\end{figure}
...
\caption[AR(1) model: comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Joe}) and population copula for different Kendall's correlation]{AR(1) model: similar analysis as depicted in Fig. \ref{fig_Cause4copula_SC_kend_ar1} but for noise generated from lower tail dependent \textbf{Survival Joe} copula. \label{fig_Cause4copula_SJ_kend_ar1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with weak noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Clayton}) and population copula for different Kendall's correlation]{Stochastic Ricker model with weak noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_C_kend_sRicker_nsd_0.1} but for noise generated from upper tail dependent \textbf{Survival Clayton} copula having normal marginal with standard deviation 0.1. \label{fig_Cause4copula_SC_kend_sRicker_nsd_0.1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with weak noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Gumbel}) and population copula for different Kendall's correlation]{Stochastic Ricker model with weak noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_C_kend_sRicker_nsd_0.1} but for noise generated from upper tail dependent \textbf{Gumbel} copula having normal marginal with standard deviation 0.1. \label{fig_Cause4copula_G_kend_sRicker_nsd_0.1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with weak noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Gumbel}) and population copula for different Kendall's correlation]{Stochastic Ricker model with weak noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_C_kend_sRicker_nsd_0.1} but for noise generated from lower tail dependent \textbf{Survival Gumbel} copula having normal marginal with standard deviation 0.1. \label{fig_Cause4copula_SG_kend_sRicker_nsd_0.1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with weak noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Joe}) and population copula for different Kendall's correlation]{Stochastic Ricker model with weak noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_C_kend_sRicker_nsd_0.1} but for noise generated from upper tail dependent \textbf{Joe} copula having normal marginal with standard deviation 0.1. \label{fig_Cause4copula_J_kend_sRicker_nsd_0.1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with weak noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Joe}) and population copula for different Kendall's correlation]{Stochastic Ricker model with weak noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_C_kend_sRicker_nsd_0.1} but for noise generated from lower tail dependent \textbf{Survival Joe} copula having normal marginal with standard deviation 0.1. \label{fig_Cause4copula_SJ_kend_sRicker_nsd_0.1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with strong noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Clayton}) and population copula for different Kendall's correlation]{Stochastic Ricker model with strong noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_C_kend_sRicker_nsd_0.1} but for noise generated from lower tail dependent \textbf{Clayton} copula  having normal marginal with standard deviation 1. \label{fig_Cause4copula_C_kend_sRicker_nsd_1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with strong noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Clayton}) and population copula for different Kendall's correlation]{Stochastic Ricker model with strong noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_SC_kend_sRicker_nsd_0.1} but for noise generated from upper tail dependent \textbf{Survival Clayton} copula  having normal marginal with standard deviation 1. \label{fig_Cause4copula_SC_kend_sRicker_nsd_1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with strong noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Gumbel}) and population copula for different Kendall's correlation]{Stochastic Ricker model with strong noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_G_kend_sRicker_nsd_0.1} but for noise generated from upper tail dependent \textbf{Gumbel} copula  having normal marginal with standard deviation 1. \label{fig_Cause4copula_G_kend_sRicker_nsd_1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with strong noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Gumbel}) and population copula for different Kendall's correlation]{Stochastic Ricker model with strong noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_SG_kend_sRicker_nsd_0.1} but for noise generated from lower tail dependent \textbf{Survival Gumbel} copula having normal marginal with standard deviation 1. \label{fig_Cause4copula_SG_kend_sRicker_nsd_1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with strong noise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Joe}) and population copula for different Kendall's correlation]{Stochastic Ricker model with strong noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_J_kend_sRicker_nsd_0.1} but for noise generated from upper tail dependent \textbf{Joe} copula having normal marginal with standard deviation 1. \label{fig_Cause4copula_J_kend_sRicker_nsd_1}}
\end{center}
\end{figure}
...
\caption[Stochastic Ricker model with weak nonise: comparing correlations and nonparametric statistic between noise-copula (\textbf{Survival Joe}) and population copula for different Kendall's correlation]{Stochastic Ricker model with strong noise: similar analysis as depicted in Fig. \ref{fig_Cause4copula_SJ_kend_sRicker_nsd_0.1} but for noise generated from lower tail dependent \textbf{Survival Joe} copula having normal marginal with standard deviation 1. \label{fig_Cause4copula_SJ_kend_sRicker_nsd_1}}
\end{center}
\end{figure}
