...
plot(pop[,1],pop[,2],xlab=expression(paste(E[1])), ylab=expression(paste(E[2])),cex.lab=1.5,
     cex.axis=1,col=rgb(0,0,0,0.5),pch=20,cex=0.6)
text(0.1,0.95,"A",cex=2)
pop<-ans_b_0.1$pop_d
plot(pop[,1],pop[,2],xlab=expression(paste(E[1])), ylab=expression(paste(E[2])),cex.lab=1.5,
     cex.axis=1,pch=20,col=rgb(0,0,0,0.5),cex=0.6)
...
\caption{Analogous to Fig. \ref{MT-fig_ms_asym_b_0.1}, but using $b=0.9$.\label{fig_ms_asym_b_0.5}}
\end{center}
\end{figure}
...
\caption{Analogous to Fig. \ref{MT-fig_ms_asym_b_0.1}, but using $b=-0.9$.\label{fig_ms_asym_b_-0.5}}
\end{center}
\end{figure}
