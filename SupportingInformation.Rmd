...
colnames(res)<-c("p-value, independence test","Best-fit copula",
                 "Best-fit copula AICw","N-copula AICw","p, CvM","p, KS","Model-avg. LT","Model-avg. UT","Model-avg. LT minus UT","cor$_{l}$ - cor$_{u}$","P$_{l}$ - P$_{u}$","D$_{u}^2$ - D$_{l}^2$")
res<-res[,-1]
...
methods for the observational hypothesis). The 
...
aphid abundance for each of the 10 sampling locations. The $p$-values in the header are from the test of independence (see section on methods for the observational hypothesis).\label{fig:greenspruce}}
\end{center}
\end{figure}
