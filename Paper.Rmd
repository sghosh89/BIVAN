...
<!--***DAN: Can you check this please? I do not think it can be right. The values on Fig. 3a range from close to 0 to over 3000. 3000 would be 3000 Mg C. I do not think a cubic meter of soil even weighs that much, including all the carbon and non-carbon components.-->
...
<!--***DAN: Yes, that makes sense, but please go back to the data as published, which should be a supporting appendix to the original publications, and make sure I have not given you erroneous data-->
