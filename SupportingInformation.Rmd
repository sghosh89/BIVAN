...
stat<-unlist(sCN)
stat<-c(stat[1:4],unname(stat[3]-stat[4]),stat[5:6],unname(stat[5]-stat[6]),stat[7:8],unname(stat[7]-stat[8]),stat[9:10],unname(stat[10]-stat[9]))
names(stat)[c(5,8,11,14)]<-c("Corl-Coru","Pl-Pu","Tl-Tu","D2u-D2l")
...
for (counter in 1:dim(surv)[3])
{
  ...
  h<-c(h[1:4],h[3]-h[4],h[5:6],h[5]-h[6],h[7:8],h[7]-h[8],h[9:10],h[10]-h[9])
