...
is one of the main foci of this paper. We give four examples below which
illustrate some of the potential ecological meaning of tail associations.
...
One way we may expect, *a priori*, a study of tail associations and of the 
complex copula dependence structures between
...
left-tail association. Nitrogen 
...
examination of the tail associations and potentially other 
patterns of dependence of variables may
...
A fourth reason why we may expect an understanding of tail associations and of complex 
...
We will explore how details, which can be captured using copulas and which
relate to tail associations, 
