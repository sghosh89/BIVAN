...
comp<-function(s,s2_p){
  
  comp<-matrix(NA,nrow=3,ncol=2)
  rownames(comp)<-c("spearman","kendall","pearson")
  colnames(comp)<-c("noise_q","pop_p")
  # Now compare between two correlations coming from noise_q and s2_p
  comp[1,1]<-unname(cor.test(s$noise_q[,1],s$noise_q[,2],method = "spearman")$estimate)
  comp[1,2]<-unname(cor.test(s2_p[,1],s2_p[,2],method = "spearman")$estimate)
  
  comp[2,1]<-unname(cor.test(s$noise_q[,1],s$noise_q[,2],method = "kendall")$estimate)
  comp[2,2]<-unname(cor.test(s2_p[,1],s2_p[,2],method = "kendall")$estimate)
  
  comp[3,1]<-unname(cor.test(s$noise_q[,1],s$noise_q[,2],method = "pearson")$estimate)
  comp[3,2]<-unname(cor.test(s2_p[,1],s2_p[,2],method = "pearson")$estimate)
...
comp(s=s,s2_p=s2_p)
#-----------------------------------------------------------------------------------------
# when noise comes from a clayton cop with kendallcor=0.8
s<-GetNoise(N=10000,fcode=3,corcoef=0.8,method="kendall",ploton=T)
s2<-Simulator_Cause4copula(cons=0.5,p0=c(0,0),noise=s$noise_q,burnin=1000)
#hist(s2[,1],breaks=1000) # it's normal
s2_p<-pnorm(s2)
#hist(s2_p[,1],breaks=1000) # it's uniform
...
comp(s=s,s2_p=s2_p)
#----------------------------------------------------------------------------------
# when noise comes from a gumbel cop with spearmancor=0.8
s<-GetNoise(N=10000,fcode=4,corcoef=0.8,method="spearman",ploton=T)
s2<-Simulator_Cause4copula(cons=0.5,p0=c(0,0),noise=s$noise_q,burnin=1000)
#hist(s2[,1],breaks=1000) # it's normal
s2_p<-pnorm(s2)
#hist(s2_p[,1],breaks=1000) # it's uniform
...
comp(s=s,s2_p=s2_p)
#------------------------------------------------------------------------------------
# when noise comes from a gumbel cop with kendallcor=0.8
s<-GetNoise(N=10000,fcode=4,corcoef=0.8,method="kendall",ploton=T)
s2<-Simulator_Cause4copula(cons=0.5,p0=c(0,0),noise=s$noise_q,burnin=1000)
#hist(s2[,1],breaks=1000) # it's normal
s2_p<-pnorm(s2)
#hist(s2_p[,1],breaks=1000) # it's uniform
