...
null hypothesis of a normal copula, answering the second part of question 1. But Table \ref{SM-tab_BMR_asym} indicates that difference in tail dependence for the BMR data copula is significantly (95% CI) not different from that of the symmetric normal copula and thus consistent with model selection results.
