...
also tested our statistics in Fig. \ref{fig_stat_image}(B - D) by testing whether $\cor_l-\cor_u$, $\Ps_l-\Ps_u$, and 
$\Dsq_u-\Dsq_l$ revealed the asymmetry of tail dependence known to be present in data simulated
from Clayton copulas (for details see Appendix \ref{SM-Test_npa_stat}).
