...
Assessment database [[RaCA](https://www.nrcs.usda.gov/wps/portal/nrcs/detail/soils/survey/?cid=nrcs142p2_054164); @Wills2014].
...
Measurments were from the central pedon of a soil core, to 1 m depth.<!--DAN: we should ask Terry to explain pedon/ R horizon-->
...
non-parametric analysis (see Appendix \ref{SI-Q1bivarnonparam}). Detailed results for each dataset are in Tables \ref{SM-tab_soilCNfit} - \ref{SM-tab_cc_asym_2000} and Figs. \ref{SM-fig_soilCN_nonparam} - \ref{SM-fig_cc2000_nonparam}. 
