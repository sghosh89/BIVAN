...
Plotter_Cause4copula_GOF(fcode=3,method = "spearman",num_keep_last=500,BS=1000)
Plotter_Cause4copula_GOF(fcode=13,method="spearman",num_keep_last=500,BS=1000)
Plotter_Cause4copula_GOF(fcode=4,method = "spearman",num_keep_last=500,BS=1000)
Plotter_Cause4copula_GOF(fcode=14,method="spearman",num_keep_last=500,BS=1000)

Plotter_Cause4copula_GOF(fcode=3,method = "kendall",num_keep_last=500,BS=1000)
Plotter_Cause4copula_GOF(fcode=13,method="kendall",num_keep_last=500,BS=1000)
Plotter_Cause4copula_GOF(fcode=4,method = "kendall",num_keep_last=500,BS=1000)
Plotter_Cause4copula_GOF(fcode=14,method="kendall",num_keep_last=500,BS=1000)
...
set.seed(seed=101)
#---------------------------------------
# I need to fix that SG_kendall ylimit error
#----------------------------
#pdf("./Results/Cause4copula_results/compare_params_pGOF_num_keep_last_2500.pdf", width=12, height=6)
#op<-par(mfrow=c(2,4),mar=c(3,3.5,3,3.5), mgp=c(1.5,0.5,0))

#Plotter_Cause4copula_GOF(fcode=3,method = "spearman",num_keep_last=2500,BS=1000)
#Plotter_Cause4copula_GOF(fcode=13,method="spearman",num_keep_last=2500,BS=1000)
#Plotter_Cause4copula_GOF(fcode=4,method = "spearman",num_keep_last=2500,BS=1000)
#Plotter_Cause4copula_GOF(fcode=14,method="spearman",num_keep_last=2500,BS=1000)

#Plotter_Cause4copula_GOF(fcode=3,method = "kendall",num_keep_last=2500,BS=1000)
#Plotter_Cause4copula_GOF(fcode=13,method="kendall",num_keep_last=2500,BS=1000)
#Plotter_Cause4copula_GOF(fcode=4,method = "kendall",num_keep_last=2500,BS=1000)
#Plotter_Cause4copula_GOF(fcode=14,method="kendall",num_keep_last=2500,BS=1000)
...
Plotter_Cause4copula_stat(numsim=50,fcode=3,method="spearman",lb=0,ub=0.1)
dev.off()
```
...
Plotter_Cause4copula_stat(numsim=50,fcode=13,method="spearman",lb=0,ub=0.1)
dev.off()
```
...
Plotter_Cause4copula_stat(numsim=50,fcode=13,method="kendall",lb=0,ub=0.1)
dev.off()
```
...
Plotter_Cause4copula_stat(numsim=50,fcode=4,method="spearman",lb=0,ub=0.1)
dev.off()
```
...
Plotter_Cause4copula_stat(numsim=50,fcode=4,method="kendall",lb=0,ub=0.1)
dev.off()
```
...
Plotter_Cause4copula_stat(numsim=50,fcode=14,method="spearman",lb=0,ub=0.1)
dev.off()
```
...
Plotter_Cause4copula_stat(numsim=50,fcode=14,method="kendall",lb=0,ub=0.1)
dev.off()
```


![Results of comparison between the parameters of environmental noise generated from a specific family of copula and estimated sample parameter (with some standard error) of the affected populations (Initially 5000 points are generated but we kept last **500** points for both noise and population data for comparison) \label{fig_Cause4copula_params_GOF}](./Results/Cause4copula_results/compare_params_pGOF_num_keep_last_500.pdf)

![Results of comparison between the parameters of environmental noise generated from a specific family of copula and estimated sample parameter (with some standard error) of the affected populations (Initially 5000 points are generated but we kept last **2500** points for both noise and population data for comparison) \label{fig_Cause4copula_params_GOF}](./Results/Cause4copula_results/compare_params_pGOF_num_keep_last_2500.pdf)


![Results of comparison between 3 types of correlation (i.e. Spearman, Kendall, Pearson) and 6 non-parametric stats ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and $\Dsq_l$) of environmental noise generated from **Clayton** copula and of the affected populations for 9 equidistant **Spearman's Rho** values in a range (0.1 to 0.9) (Initially 5000 points are generated but we kept last 500 points for both noise and population data for comparison) \label{fig_Cause4copula_C_spear}](./Results/Cause4copula_results/Clayton_spearman.pdf)

![Results of comparison between 3 types of correlation (i.e. Spearman, Kendall, Pearson) and 6 non-parametric stats ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and $\Dsq_l$) of environmental noise generated from **Clayton** copula and of the affected populations for 9 equidistant **Kendall's Tau** values in a range (0.1 to 0.9) (Initially 5000 points are generated but we kept last 500 points for both noise and population data for comparison) \label{fig_Cause4copula_C_kend}](./Results/Cause4copula_results/Clayton_kendall.pdf)

![Results of comparison between 3 types of correlation (i.e. Spearman, Kendall, Pearson) and 6 non-parametric stats ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and $\Dsq_l$) of environmental noise generated from **Survival Clayton** copula and of the affected populations for 9 equidistant **Spearman's Rho** values in a range (0.1 to 0.9) (Initially 5000 points are generated but we kept last 500 points for both noise and population data for comparison) \label{fig_Cause4copula_SC_spear}](./Results/Cause4copula_results/SClayton_spearman.pdf)

![Results of comparison between 3 types of correlation (i.e. Spearman, Kendall, Pearson) and 6 non-parametric stats ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and $\Dsq_l$) of environmental noise generated from **Survival Clayton** copula and of the affected populations for 9 equidistant **Kendall's Tau** values in a range (0.1 to 0.9) (Initially 5000 points are generated but we kept last 500 points for both noise and population data for comparison) \label{fig_Cause4copula_SC_kend}](./Results/Cause4copula_results/SClayton_kendall.pdf)

![Results of comparison between 3 types of correlation (i.e. Spearman, Kendall, Pearson) and 6 non-parametric stats ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and $\Dsq_l$) of environmental noise generated from **Gumbel** copula and of the affected populations for 9 equidistant **Spearman's Rho** values in a range (0.1 to 0.9) (Initially 5000 points are generated but we kept last 500 points for both noise and population data for comparison) \label{fig_Cause4copula_G_spear}](./Results/Cause4copula_results/Gumbel_spearman.pdf)

![Results of comparison between 3 types of correlation (i.e. Spearman, Kendall, Pearson) and 6 non-parametric stats ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and $\Dsq_l$) of environmental noise generated from **Gumbel** copula and of the affected populations for 9 equidistant **Kendall's Tau** values in a range (0.1 to 0.9) (Initially 5000 points are generated but we kept last 500 points for both noise and population data for comparison) \label{fig_Cause4copula_G_kend}](./Results/Cause4copula_results/Gumbel_kendall.pdf)

![Results of comparison between 3 types of correlation (i.e. Spearman, Kendall, Pearson) and 6 non-parametric stats ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and $\Dsq_l$) of environmental noise generated from **Survival Gumbel** copula and of the affected populations for 9 equidistant **Spearman's Rho** values in a range (0.1 to 0.9) (Initially 5000 points are generated but we kept last 500 points for both noise and population data for comparison) \label{fig_Cause4copula_SG_spear}](./Results/Cause4copula_results/SGumbel_spearman.pdf)

![Results of comparison between 3 types of correlation (i.e. Spearman, Kendall, Pearson) and 6 non-parametric stats ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_u$ and $\Dsq_l$) of environmental noise generated from **Survival Gumbel** copula and of the affected populations for 9 equidistant **Kendall's Tau** values in a range (0.1 to 0.9) (Initially 5000 points are generated but we kept last 500 points for both noise and population data for comparison) \label{fig_Cause4copula_SG_kend}](./Results/Cause4copula_results/SGumbel_kendall.pdf)
