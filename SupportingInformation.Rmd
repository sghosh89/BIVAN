...
Akaike Information Criterion (AIC), Bayesian Information Criterion (BIC) and accompanying model weights ($\text{AIC}_{\text{w}}$, $\text{BIC}_{\text{w}}$) were generated using standard formulas @burnham2003_modelselection. 
<!--Shya, we here need a reference to the Burnham and Anderson book-->
Descriptions of these copula families can be found in introductory texts on copulas @burnham2003_modelselection, @nelsen2007_copula
...
### Stat-testing of Non-parametric analysis (for limited number of datapoints) \label{Stat_testing}
