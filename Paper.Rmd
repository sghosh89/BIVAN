...
non-arametric statistics, which were previously applied to 
data to answer Q1, to the 
simulation outputs to discover if the mechanism built into the model could
...
our nonparametric statistics (Tables \ref{SM-tab_stat_npa_asym_1} -\ref{SM-tab_stat_npa_asym_2}) statistically confirmed the visual result.
...
But we should put the figs in the sup mat, not the stats results, I think, but we could put the figs-->
