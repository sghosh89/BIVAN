...
plot(d[,1],d[,2],type="p",col="red",xlab="Soil C",ylab="Soil N",cex.lab=2.5,cex.axis=1.5)
par(op)
dev.off()
```
...
op<-par(mar=c(5.1, 5.1, 0.2, 2.1))
plot(b[,1],b[,2],type="p",col="red",xlab="log(Mass)",ylab="log(BMR)",cex.lab=2.5,cex.axis=1.5)
par(op)
dev.off()
...
op<-par(mar=c(5.1, 5.1, 0.2, 2.1))
plot(m[,1],m[,2],type="p",col="red",xlab="log(Mass)",ylab="log(BMR)",cex.lab=2.5,cex.axis=1.5)
par(op)
dev.off()
...
cop_HB<-function(db,dp,year,rawplot,ploton){
  ...
  if(ploton==T){
    if(rawplot==T){
      op<-par(mar=c(5.1, 5.1, 1.5, 2.1))
      plot(tab_dbp$avg.H,tab_dbp$avg.Biomass,xlab="avg.H",ylab="avg.Biomass",col="red",pch=1,cex.lab=2.5,cex.axis=1.5)
      mtext(paste0("Year=",year),cex=2)
      par(op)
    }else{
      op<-par(mar=c(5.1, 5.1, 1.5, 2.1))
      plot(cop_tab_dbp$avg.H,cop_tab_dbp$avg.Biomass,xlab="u",ylab="v",col="red",pch=1,cex.lab=2.5,cex.axis=1.5,
...
op<-par(mar=c(5.1, 5.1, 0.2, 2.1))
plot(d1$Dat,d2$Dat,type="p",col="red",xlab="Green-spruce aphid count (loc. 4)",ylab="Green-spruce aphid count (loc. 11)",cex.lab=2.5,cex.axis=1.5)
par(op)
dev.off()
...
op<-par(mar=c(5.1, 5.1, 0.2, 2.1))
plot(d1$Dat,d2$Dat,type="p",col="red",xlab="Leaf-plum curling's first-flight (loc. 2)",ylab="Leaf-plum curling's first-flight (loc. 5)",cex.lab=2.5,cex.axis=1.5)
par(op)
dev.off()
