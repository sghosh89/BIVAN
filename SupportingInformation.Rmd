...
plot(s$d_seq,s$risk_left,xlim=c(0,1),ylim=c(0,1),type="b",col="black",
     ...
     cex.lab=1.5,cex.axis=1.5,cex=1,pch=16,lwd=1.5)
lines(s1$d_seq,s1$risk_left,type="b",lwd=1.5,cex=1,pch=1)
legend(x=0.3,y=0.9, title=paste0("r = ",params," , left tail dep. in noise"), c("numlocs = 5","numlocs = 25"), 
       pch=c(16,1), lty=c(1,1),
       horiz=F, bty='n') 

plot(s$d_seq,s$risk_right,xlim=c(0,1),ylim=c(0,1),type="b",col="grey",
     xlab="d",ylab="Extinction risk",
     cex.lab=1.5,cex.axis=1.5,cex=1,pch=16,lwd=1.5)
lines(s1$d_seq,s1$risk_right,type="b",lwd=1.5,cex=1,pch=1,col="grey")
legend(x=0.3,y=0.9, title=paste0("r = ",params," , right tail dep. in noise"), c("numlocs = 5","numlocs = 25"), 
       pch=c(16,1), lty=c(1,1), col=c("grey","grey"),
       horiz=F, bty='n') 
