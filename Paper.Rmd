...
statistics.
***Shya: In code we used the sum of squared distances divided by n(=number of points lying within two boundaries) which I think okay to be called as "average-squared distance" or average of squared distances between points within the two boundaries.
...
<!--***DAN: made it to here 2018 12 18 9pm-->
