...
Descriptions of these copula families can be found in introductory texts on copulas @nelsen2007_copula
<!--Shya to please insert references for the book on copulas by Joe - it is on my desk, come get it please-->
...
First we chose a set of parameters [using *iRho* from `Copula` package] for each type of copula for which spearman correlation will be $10$ equispaced number in between [$0,0.9$]. Then for each parameter (or spearman value) of each type of copula we carried out $100$ simulation and calculated ($\cor_l$, $\cor_u$, $\Ps_l$, $\Ps_u$, $\Dsq_l$, $\Dsq_u$) stats. We took mean of our statistic $\cor_l-\cor_u$, $\Ps_l-\Ps_u$ and $\Dsq_u-\Dsq_l$ over $100$ simulations and In Figure \ref{fig_stat_testing35}, we plotted those statistic against spearman correlation. We put the standard error bar around each point in the plot and these errors got minimized with increasing numbe of data points [Figure \ref{fig_stat_testing1000}]. Statistic $\cor_l-\cor_u$, $\Ps_l-\Ps_u$ and $\Dsq_u-\Dsq_l$ should be $0$ for spearman=$0$ for *Clayton* and *Survival Clayton* and should remain $0$ for all values of spearman for symmetric copula like *Normal* and *Frank*. To verify this, we executed t-test and report the $p$-values for each case and most of the case shows $p>0.05$.

<!--Shya, why is message=F and warning=F? This is risky unless you ran it already without these and 
know what the warnings are and that we can ignore them. If this is the case, please add a comment here
explaining why it is safe. If you do not have a complete understanding of the warnings and messages,
please do not suppress them. Even if you do understand them, there are probably better ways to handle 
it than supressing them.-->
```{r stat_testing_save_result, message=F, warning=F, echo=F, cache=T, cache.extra=list(seed,mtime("TestStats_multivar_dataset.R"))}
set.seed(seed)

#Shya, there are a lot of functions in TestStats_multivar_dataset, do we still need all of them? Please delete any that 
#we no longer use! You need to keep code clean!
...
b<-callfn$paramlist
plotter_stat_testing(res_pt35_rankF,"res_pt35_rankF",b,resultsloc)
plotter_stat_testing(res_pt35_rankT,"res_pt35_rankT",b,resultsloc)
plotter_stat_testing(res_pt1000_rankF,"res_pt1000_rankF",b,resultsloc)
plotter_stat_testing(res_pt1000_rankT,"res_pt1000_rankT",b,resultsloc)
```
...
atdres<-data.frame(Statistic=c("$cor_l-cor_u$","$P_l-P_u$","$D^2_u-D^2_l$"),
                   Kendall=rep("",3),
...
## Aphid abundance data for 'Green spruce aphid' \label{Ex_count}
...
knitr::kable(RES_aphid_count$LTdep_AICw,
             format='pandoc',
             caption = "Aphid_count : model averaged lower tail dependence statistic for each selective location pair\\label{tab_count_LTdep_AICw}",
             booktabs=TRUE
             )
```
...
knitr::kable(RES_aphid_count$UTdep_AICw,
             format='pandoc',
             caption = "Aphid_count : model averaged upper tail dependence statistic for each selective location pair\\label{tab_count_UTdep_AICw}",
             booktabs=TRUE
             )
```
...
knitr::kable(RES_aphid_count$LTdep_AICw-RES_aphid_count$UTdep_AICw,
             digits = 5,
             format='pandoc',
             caption = "Aphid_count : model averaged lower tail dependence - model averaged upper tail dependence statistic for each selective location pair\\label{tab_count_LTmUT}",
             booktabs=TRUE
             )
```
 ...
 *  As expected, when extinction risk calculated after $25$ years, was plotted against each $d$ (=degree of dispersion) we varied, we found that extinction risk was higher for data came from left tail dependent environmental fluctuations than right tail dependent one. With increasing $numlocs$ from $5$ to $25$, extinction risk decreased [for a fixed $d$] but this effect was more prominent in case of data came from right tail-dep environmental noise. [see Figure \ref{fig_risk_r0_numlocs5} - Figure \ref{fig_risk_r0_numlocs25}]. 
 

```{r fig_risk_r0_numlocs5, echo=F, cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="LC model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0_numlocs5}", fig.height=4, fig.width=8}
set.seed(seed)
varying_d(numsims=10000,numsteps =25,numlocs=5,r=0,K=100)
```

```{r fig_risk_r0_numlocs25, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="LC model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0_numlocs25}", fig.height=4, fig.width=8}
set.seed(seed)
varying_d(numsims=10000,numsteps =25,numlocs=25,r=0,K=100)
```
 ...
 *  For ricker model when extinction risk calculated after $25$ years, was plotted against each $d$ (=degree of dispersion) we varied, we found that extinction risk was higher for data came from left tail dependent environmental fluctuations than right tail dependent one upto $r=0.7$. For $r>0.7$, extinction risk is greater for data came from right tail dependent environmental fluctuations.
  ...
  * With increasing $K$ from $100$ to $200$, extinction risk in both case gets decreased as expected. [see Figure \ref{fig_risk_r0.05} - Figure \ref{fig_risk_r0.05_K200}]

 * With increasing $numlocs$ from $5$ to $25$, extinction risk decreased [for a fixed $d$] but this effect was more prominent in case of data came from left tail-dep environmental noise. [see Figure \ref{fig_risk_r1.25} - Figure \ref{fig_risk_r1.25_numlocs25}]. 
 

```{r fig_risk_r0.05, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0.05}", fig.height=4, fig.width=8}
set.seed(seed)
r<-0.05
numlocs<-5
K<-100
varying_d(numsims=10000,numsteps =25,numlocs=numlocs,r=r,K=K)
```

```{r fig_risk_r0.05_K200, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0.05_K200}", fig.height=4, fig.width=8}
set.seed(seed)
r=0.05
numlocs<-5
K<-200
...
```{r fig_risk_r0.25, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0.25}", fig.height=4, fig.width=8}
set.seed(seed)
r=0.25
numlocs<-5
K<-100
...
```{r fig_risk_r0.5, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0.5}", fig.height=4, fig.width=8}
set.seed(seed)
r=0.5
numlocs<-5
K<-100
...
```{r fig_risk_r0.6, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0.6}", fig.height=4, fig.width=8}
set.seed(seed)
r=0.6
numlocs<-5
K<-100
...
```{r fig_risk_r0.7, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0.7}", fig.height=4, fig.width=8}
set.seed(seed)
r=0.7
numlocs<-5
K<-100
...
```{r fig_risk_r0.75, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0.75}", fig.height=4, fig.width=8}
set.seed(seed)
r=0.75
numlocs<-5
K<-100
...
```{r fig_risk_r0.9, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r0.9}", fig.height=4, fig.width=8}
set.seed(seed)
r=0.9
numlocs<-5
K<-100
...
```{r fig_risk_r1.0, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r1.0}", fig.height=4, fig.width=8}
set.seed(seed)
r=1.0
numlocs<-5
K<-100
...
```{r fig_risk_r1.25, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r1.25}", fig.height=4, fig.width=8}
set.seed(seed)
r=1.25
numlocs<-5
K<-100
...
```{r fig_risk_r1.25_numlocs25, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r1.25_numlocs25}", fig.height=4, fig.width=8}
set.seed(seed)
r=1.25
numlocs<-25
K<-100
...
```{r fig_risk_r1.5, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r1.5}", fig.height=4, fig.width=8}
set.seed(seed)
r=1.5
numlocs<-5
K<-100
...
```{r fig_risk_r1.75, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r1.75}", fig.height=4, fig.width=8}
set.seed(seed)
r=1.75
numlocs<-5
K<-100
...
```{r fig_risk_r1.95, echo=F,  cache=T, cache.extra=list(seed,mtime("mydispersal.R"),mtime("ExtremeTailDep.R")), fig.cap="Ricker model : Plot Extinction risk vs. d(degree of dispersal).\\label{fig_risk_r1.95}", fig.height=4, fig.width=8}
set.seed(seed)
r=1.95
numlocs<-5
K<-100
