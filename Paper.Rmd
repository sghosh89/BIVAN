...
environmental variables. If large meteorological events are also spatially widespread, then
...
***DAN: that's OK, the purpose here is to give background on what has been done, it does not all have to pit perfectly. And also, the topic sentence just says non-N, which that is.--> 
...
based approach in assessing the probability of vegetation related drought across China. 
<!--***DAN: Shya, what do you mean by "vegetation related drought"? Is this a kind of drought
that is somehow caused by the vegetation? That's what it sounds like, and it sounds like what
they studied was the probability that such a drought occurred. If that's not what you mean, please
rephrase.-->
...
-->
Other mechanisms that we have not considered likely also operate to produce copula structure
in ecological datasets.
For instance, we detected non-N structure and tail dependence in our 
metabolic rate-versus-body mass datasets,
but the mechanisms discussed above do not apply directly in a macroevolutionary context.
We hope by enumerating two potential mechanisms we help inspire additional theoretical and
empirical research on the
potentially numerous mechanisms of copula structure that may apply in diverse ecological datasets.
<!--***DAN: beef this up if/when we get inputs from Mark and Van-->
