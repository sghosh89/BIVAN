...
\end{center}
\end{figure}
<!--***DAN: Shya, it say "Avg. H" and "Avg. biomass" on the axes of D. Reading the sup mat
data section carefully, I presume this is because there were multiple strips per plot
and these were averaged. However, the averaging is not mentioned in the main text, so I think
this will be confusing for some readers. Can you please change the axes to read "Biomas" and "H"?--> 
...
<!--***DAN: stopped here 2019 05 03 321pm-->
