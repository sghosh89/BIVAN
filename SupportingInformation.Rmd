...
plot(v_BMR[,1],v_BMR[,2],col="red",xlab="ln(mass)",ylab="BMR",cex.lab=2,cex.axis=2) # copula plot btw ln(Mass) vs. BMR
par(op)
dev.off()
```

![Copula plot for BMR dataset \label{fig_BMR_cop}](./Results/BMR_results/BMR_vs_lnmass.pdf){ width=30%, height=30% }
...
knitr::kable(tab_BMR_asym,
             format="pandoc",
             caption = "Results for tests of whether asymmetry of tail dependence was significant compared to a normal-copula null hypothesis (best fit is here Frank with symmetric tail dep)? \\label{tab_BMR_asym}",
             booktabs=T)
```
