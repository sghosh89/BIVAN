...
cop_HB<-function(db,dp,year,rawplot,ploton){
  ...
  if(ploton==T){
    if(rawplot==T){
      ...
      plot(tab_dbp$avg.H,tab_dbp$avg.Biomass,xlab="avg.H",ylab="avg.Biomass",col="red",pch=1,cex.lab=2,cex.axis=1.5)
...
library(tibble)
aphid_info <- tibble(c("Apple grass aphid","Bird cherry oat aphid","Black bean aphid","Blackberry cereal aphid","Blackcurrant sowthistle aphid",
           ...
           c("Rhopalosiphum insertum", "Rhopalosiphum padi", "Aphis fabae", "Sitobion fragariae", "Hyperomyzus lactucae",
...
op<-par(mar=c(5.1, 5.1, 0.2, 2.1))
plot(d1$Dat,d2$Dat,type="p",col="red",xlab="Green-spruce aphid count (loc. 4)",ylab="Green-spruce aphid count (loc. 11)",cex.lab=2.5,cex.axis=2)
par(op)
dev.off()
...
op<-par(mar=c(5.1, 5.1, 0.2, 2.1))
plot(d1$Dat,d2$Dat,type="p",col="red",xlab="Leaf-plum curling's first-flight (loc. 2)",ylab="Leaf-plum curling's first-flight (loc. 5)",cex.lab=2.5,cex.axis=2)
par(op)
dev.off()
...
mtext(paste0("p= ",ans$p_left_mncurv),side = 3, line=-2, adj=0.5, col="navyblue",cex=2)
par(op)
dev.off()
...
plot(ans$realTL_stats$s.points,xlab=expression(log[10]("spatial mean")),
     ...
     cex.axis=1.5,cex.lab=1.5)
mtext(paste0("mean curvature= ",round(unname(ans$realTL_stats$s.stats[7]),3)),side = 3, line=-2, adj=0, col="navyblue",cex=2)
...
plot(ans_s[[id]]$s.points,xlab=expression(log[10]("spatial mean")),
     ...
     cex.axis=1.5,cex.lab=1.5)
mtext(paste0("mean curvature= ",round(ans$good_surrog_mncurv[id],3)),side = 3, line=-2, adj=0, col="navyblue",cex=2)
