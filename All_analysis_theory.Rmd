...
Shyamolina, can you please build on what I have started here in some of the ways listed? Use your judgement and explore whatever results seem promising and at least somewhat biologically relevant. Perhaps a good place to start would be generalizing popsim_ml to take a dispersal matrix which links each location to each other location in a general way. That will make it easier to then experiment with local dispersal, instead of the global dispersal I have implemented. 
