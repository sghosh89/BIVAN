...
tab_stat_npa_asym<-cbind(b=rep(c(0.1,0.1,-0.1,-0.1,0.9,0.9,-0.9,-0.9),each=3),
  g=rep(c(1,2,1,2,1,2,1,2),each=3),tab_stat_npa_asym)
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=15 cm]{./Results/asym_sens_results/a_0.2_b_-0.1_r_0.8_asym_sens.pdf}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=15 cm]{./Results/asym_sens_results/a_0.2_b_0.9_r_0.8_asym_sens.pdf}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=15 cm]{./Results/asym_sens_results/a_0.2_b_-0.9_r_0.8_asym_sens.pdf}
