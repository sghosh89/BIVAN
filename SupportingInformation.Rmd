...
author: "S. Ghosh, T. Loecke, C.P. Reid, Daniel Reuman"
...
resampling scheme, as described in Methods (Table \ref{tab_count_resamp}).
...
<!--As for the count data, I don't think we need this. If you disagree, let me know, otherwise pls delete the commented text and this comment.
