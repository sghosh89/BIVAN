...
extended Lewinton-Cohen model (Fig. \ref{fig_extrisk_lcohen_local}). 
...
on Taylor's law in Appendix \ref{SM-Consequence_TL_simulation}.
...
\caption{Extinction risk for the metapopulation extension of the Lewinton-Cohen model, after 
