...
6) In the Discussion, you maybe need to point out not only that we
...
8) say in Discussion that you could have used non-ranks for the nonparam stats - this
...
<!--***DAN: you need to change the box around the Cedar Creek data-->
...
int he Inrtoduction, Background, and methods sections and 
...
will be unaffected by nonlinear functions such as $f$. The same difficulty will pertain in any
...
in ecology beyond the specific tools we have employed. For instance, multivariate copulas are useful for 
...
multiple species in the same way that athe value of an investment portfolio is the sum 
...
distributions have continuous, strictly 
monotonic distribution functions; this was for simplicity and because such a simpler
