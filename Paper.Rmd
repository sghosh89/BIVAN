...
and for each Kendall correlation value $\tau=0.1,0.2,\ldots,0.9$, 
we generated 5000 noise pairs $(\epsilon_1(t),\epsilon_2(t))$ from the
...
time steps of the simulation. For each model, copula family, and $\tau$, the following
