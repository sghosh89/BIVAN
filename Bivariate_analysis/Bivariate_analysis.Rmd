...
fit_BIV<-function(d,families,level=0.05){
  ...
  ans<-OurBiCopSelect(u1,u2,families,AICBIC="AIC",level=0.05,numBS=4,gofnormal=T)
  if(ans$IndepTestRes<level){
    ...
    if(pmin<0.2){
      ans2<-OurBiCopSelect(u1,u2,families,AICBIC="AIC",level=0.05,numBS=5,gofnormal=T)
      gfc_numBS<-1000
