...
<!--***DAN: Please fill in X and Y. If it was the Kendall that was used, please 
...
***Shya: I don't know the answer, the code which generates extreme right or left tail dep noise 
is written by you : ExtremeTailDep.R; there is no mention to preserve spearman or kendall or pearson.
I called retd function from ExtremeTaildep.R in another script mydispersal.R line 116, 128 
to generate right and left tail dep. noise.-->
...
among two nearest neighbors ($r=0$, $d=$ rate of dispersal). 
Left-tail dependent environmental noise caused higher 
extinction risk than right-tail dependent one for number of patches $(A)$ $N = 5$ and $(B)$ $N = 25$, respectively,
where both case showed lower extinction risk with increasing number of patches.\label{fig_extrisk_lcohen_local}}
\end{center}
\end{figure}
