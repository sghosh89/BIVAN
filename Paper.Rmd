...
still rare. Whereas @Anderson2018 provide a specific methodological pathway, based partly 
on copulas, for the important problem of the 
analysis of multivariate ecological population count data;
...
both less abundant, and C and N are more strongly associated in both
...
comparisons (Table \ref{tab_soilCN_asym}). Results confirmed that
...
both small. Our generally affirmative (except for Cedar Creek), 
...
green spruce aphid and \textit{Ceratium furca} abundance, whereas leaf-curling aphid
...
mathematical completeness will not be avilable for other methods.
