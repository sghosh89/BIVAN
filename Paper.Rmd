...
<!--***DAN: Shyamolina, these do not match with the value in table 6! Please check BOTH values and make them correct, and make them agree! You seemed to have used the values for the P statistic by mistake.-->
...
<!--***DAN: combin all 3 sup mat figs on this subject into one sup mat fig-->
...
do out model selection analysis here)
