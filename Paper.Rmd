...
dependence (Table \ref{tab_multivar_summary}), we did the analogous one-tail test
in the right tail.

<!--Reminder that Table 2 says:
Green spruce - lower tail
Leaf-curling - upper tail
Cerratium - lower tail
methane - marginal lower tail-->

<!--***DAN: stopped here in this section, 2019 02 12, 633am-->
