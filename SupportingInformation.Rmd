...
within each column. See section \ref{Background} in the main text for a formal description of 
...
points(kend.points.res[[1]][,1,1],kend.points.res[[1]][,2,1],type='p',pch=19,cex=.75,col='black')
points(kend.points.res[[1]][,1,2],kend.points.res[[1]][,2,2],type='p',pch=1,cex=.75,col='black')
...
plot(kend.points.res[[2]][,1,],kend.points.res[[2]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(kend.points.res[[2]][,1,1],kend.points.res[[2]][,2,1],type='p',pch=19,cex=.75,col='black')
points(kend.points.res[[2]][,1,2],kend.points.res[[2]][,2,2],type='p',pch=1,cex=.75,col='black')
...
plot(kend.points.res[[3]][,1,],kend.points.res[[3]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(kend.points.res[[3]][,1,1],kend.points.res[[3]][,2,1],type='p',pch=19,cex=.75,col='black')
points(kend.points.res[[3]][,1,2],kend.points.res[[3]][,2,2],type='p',pch=1,cex=.75,col='black')
...
plot(kend.points.res[[4]][,1,],kend.points.res[[4]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(kend.points.res[[4]][,1,1],kend.points.res[[4]][,2,1],type='p',pch=19,cex=.75,col='black')
points(kend.points.res[[4]][,1,2],kend.points.res[[4]][,2,2],type='p',pch=1,cex=.75,col='black')
...
plot(spea.points.res[[1]][,1,],spea.points.res[[1]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(spea.points.res[[1]][,1,1],spea.points.res[[1]][,2,1],type='p',pch=19,cex=.75,col='black')
points(spea.points.res[[1]][,1,2],spea.points.res[[1]][,2,2],type='p',pch=1,cex=.75,col='black')
...
plot(spea.points.res[[2]][,1,],spea.points.res[[2]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(spea.points.res[[2]][,1,1],spea.points.res[[2]][,2,1],type='p',pch=19,cex=.75,col='black')
points(spea.points.res[[2]][,1,2],spea.points.res[[2]][,2,2],type='p',pch=1,cex=.75,col='black')
...
plot(spea.points.res[[3]][,1,],spea.points.res[[3]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(spea.points.res[[3]][,1,1],spea.points.res[[3]][,2,1],type='p',pch=19,cex=.75,col='black')
points(spea.points.res[[3]][,1,2],spea.points.res[[3]][,2,2],type='p',pch=1,cex=.75,col='black')
mtext(paste("Frank"),side = 3, line=-2, adj=0.1, col="black",cex=2)
...
plot(spea.points.res[[4]][,1,],spea.points.res[[4]][,2,],type='p',pch=19,cex=.75,xlim=xlimits,ylim=ylimits,
     xlab=expression(log[10]("spatial mean")),ylab=expression(log[10]("spatial variance")),
     cex.axis=2,cex.lab=3,col="grey")  
points(spea.points.res[[4]][,1,1],spea.points.res[[4]][,2,1],type='p',pch=19,cex=.75,col='black')
points(spea.points.res[[4]][,1,2],spea.points.res[[4]][,2,2],type='p',pch=1,cex=.75,col='black')
