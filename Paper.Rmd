...
# Background concepts and methods for Q1: detecting copula structure \label{Methods}

We addressed Q1 in part via a model selection procedure in which the normal copula
...
Information Criteria (AIC and BIC). To make the results more easily interpretable
to readers unfamiliar with copulas, we first introduce the normal copula and 
some alternative copulas we used; and we operationally introduce measures of tail dependence
and asymmetry of tail dependence. 
Additional details are in Appendix \ref{SM-copula_details}. 
...
Left- and right-tail dependence are $0$ for a the normal copula, and this 
serves as a reference for tail dependence in other copulas. The Clayton and 
...
and $0$ lower-tail dependence. For our model selection procedure (see below), we considered


Families considered (with abbreviations here indicated) included the **N**ormal/Gaussian, **C**layton, **G**umbel, **F**rank, **J**oe, **BB1**, **BB6**, **BB7**, **BB8**, **S**urvival **C**layton , **S**urvival **G**umbel, **S**urvival **J**oe, **S**urvival **BB1**, **S**urvival **BB6**, **S**urvival **BB7** and **S**urvival **BB8** copulae. These copulae were chosen carefully so that they covered the whole range from exclusively lower (C, SG, SJ, SBB6, SBB8) or upper tail dependence (SC, G, J, BB6, BB8) to both tail dependence (BB1, SBB1, BB7, SBB7) in addition to two symmetric copulae (N, F). 
...
survival-Clayton copulas with parameter 5, and Appendix. \label{fig_cop_pedag3}}
\end{center}
\end{figure}
