...
<!--Shya, you added a hyperlink that lead to some of our code earlier in this document,
and I have added one here, and the knitted pdf has the hyperlink, but the text "basic unit tests" 
is the same color as all the surrounding text. So the only way you can tell that there is a 
hyperlink there is if you happen to mouse over the words. We need to have a color that all
text with a hyperlink is rendered in, preferably automatically. Can you figure out how to 
make that happen, both here and for the earlier hyperlinks?-->
