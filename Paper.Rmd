...
<!--***DAN: stopped here for methods of Q2-->

<!--***DAN: How much of the material from Appendix S8 should be moved into
the main text? I am thinking a fair amount of it. Currrently there
is really no results on that topic at all in the main text, and that seems
a bit ridiculous and probably is why the referee said we treated this 
material in a "breezy" way.-->
...
<!--***DAN: reorder sup mat figs so they are cited in order-->
...
and replace by the bigger one which was in the supp mat, now below.
\begin{figure}[!h]
\begin{center}
...
\end{center}
\end{figure}
<!--***DAN: Shyamolina, the panels in the bottom row do not line up with the others. 
I remember you fixed this before for the sup mat figs, can you plase fix it again here?
Also, can you make the panels smaller or more tightly packed or soemthing
so the whole figure plus caption fits on a page?-->

<!--***DAN: Got to here in results for Q2-->
