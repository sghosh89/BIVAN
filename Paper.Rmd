...
***Shya: Done but please check the last line of this para : 
@Goswami2018 this paper tests model with 3 different copula : Frank, Gaussian, Plackett, as far as I know all are symmetric, 
so non-N copula may be best fit but in this case I could not understand how tha tail-dep. thing would fit.--> 
Using a bivariate mixed model approach with copula, 
past study [@Serinaldi2008] examined the spatial dependence 
of rainfall observations (7 years with 30 min. time resolution) 
within a rain gauge network located in Central Italy and concluded that Gumbel or Student 2-copulas 
were possible candidates for modelling bivariate dependence at several time scale. A relatively recent 
study [@liu2016probabilistic] used copula 
based approach in assessing the probability of vegetation related drought across China. They found 
majority of non-Normal copula as best fit for the dependence between vegatation index (NDVI) 
and climatic variables (e.g. precipitation and temperature) for each month of the growing season
(April-October). Another long-term study (1950–2014) in the Loess Plateau (LP) of China [@She2018]
showed that Gumbel copula (with upper tail dependence) can better model the spatial dependence 
(in the 93.1$\%$ case of the 
total grid considered) between the drought variables 
...
over North Sikkim Himalaya using spatial data set at different time scales [@Goswami2018]. 
...
macro-scale evolutionary biology?-->


<!--Brief conclusion of some kind-->
...
We thank the many contributors to the large datasets we used; D. Stevens and P. Verrier for data extraction; and Joel E. Cohen, Jonathan Walter, Thomas Anderson, and Lei Zhao for helpful suggestions. We thank James Bell of the Rothamsted Insect Survey (RIS). 
