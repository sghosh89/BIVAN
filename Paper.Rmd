...
information on the marginals \cite{Genest2007}. 
...
example pdfs corresponding to bivariate N copulas for various values of $p$.
...
copula, making possible comparisons of the degree to which the N copula versus
...
is Kendall's tau for the data \cite{Genest2007}. We used the 
