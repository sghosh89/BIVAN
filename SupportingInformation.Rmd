...
```{r cause4copula_stat_clayton_ar1_posbeta, echo=F, results="hide", cache=T, cache.extra=list(seed,mtime("Cause4copula.R"),mtime("CopulaFunctions_flexible.R"),mtime("MyBiCopGofTest.R"),mtime("preprocessors.R"))}
#source("Cause4copula.R")
#-----------------
#set.seed(seed)
#---------------------------------------
# This chunk stores results for ar1 model 
#resloc<-"./Results/Cause4copula_results/"
#model<-"ar1"
#params<-c(0.5) # this parameter is beta in ar1 model
#tempo<-paste(resloc,"Cause4copula_stat_results_",model,"_beta_",params,sep="")
...
#                          params=params,p0=c(0,0),model="ar1")
...
```{r cause4copula_stat_clayton_ar1_negbeta, echo=F, results="hide", cache=T, cache.extra=list(seed,mtime("Cause4copula.R"),mtime("CopulaFunctions_flexible.R"),mtime("MyBiCopGofTest.R"),mtime("preprocessors.R"))}
source("Cause4copula.R")
#-----------------
set.seed(seed)
#---------------------------------------
