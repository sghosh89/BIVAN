...
we had 817 bivariate characters for each of 500 simulations. 
<!--***DAN: Shya to insert as the rest of this paragraph a description of what 
you did to each of these datasets to assess symmetry or asymmetry of tail dependence-->

<!--***DAN: Shya, please insert a new para here with a description of results, including a new figure with 5 panels showing the 5 histograms you showed me.-->
...
Additionally, changes
    in the rate of molecular evolution make the estimation of dates difficult [@HeathM2014] even when branch lengths are accurately estimated.
