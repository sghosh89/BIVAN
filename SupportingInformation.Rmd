...
colnames(s)<-c("Statistic","Lower 95\\% CI", "Mean", "Upper 95\\% CI")
rownames(s)<-c("Spearman","Kendall","$\\cor_l$","$\\cor_u$","$\\Ps_l$","$\\Ps_u$","$\\Dsq_l$","$\\Dsq_u$","$\\cor_l - \\cor_u$","$\\Psq_l - \\Psq_u$","$\\Dsq_u - \\Dsq_l$")
knitr::kable(s,
             format = "pandoc",
...
## Aphid first flight data for 'Leaf-curling plum aphid' \label{Ex_ff}
