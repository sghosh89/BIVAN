...
<!--Shyamolina, let's not put in newpages and other spacing modifications until possibly at the end, once all the 
content is essentially settled-->
...
#initialize
npa_res_CN<-data.frame(Statistic=c("Kendall","Spearman","Corl","Coru","CorlmCoru","Corlt0p1","Corgt0p9","Corlt0p1mCorgt0p9","D2l","D2u","D2umD2l","D2lt0p1","D2gt0p9","D2lt0p9mD2gt0p1"),Value=NA,Frac_of_K_surr_gt_val=NA,Frac_of_S_surr_gt_val=NA)
